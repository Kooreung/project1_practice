        ...
        <div class="col-10">
            ...
            <form action="/edit" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input id="inputRestaurant" name="restaurantName" type="text" class="form-control"
                           value="${restaurantBoard.restaurantName}" required>
                </div>
                <div class="mb-3">
                    <label for="inputFoodName" class="form-label">
                        음식이름
                    </label>
                    <input id="inputFoodName" name="foodName" type="text" class="form-control"
                           value="${restaurantBoard.foodName}" required>
                </div>
                <div class="mb-3">
                    ...
                    <input id="inputPrice" name="price" type="text" class="form-control"
                           value="${restaurantBoard.price}" required>
                </div>
                <div class="mb-3">
                    <label for="inputPrice" class="form-label">
                        점수
                ...
                <div class="mb-3">
                    ...
                    <textarea id="inputTextarea" name="content" class="form-control" cols="30" rows="10"
                              required>${restaurantBoard.content}</textarea>
                </div>
                <div class="mb-3">
